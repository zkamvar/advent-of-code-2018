...
# method to determine any region's type based on its erosion level. The erosion
# level of a region can be determined from its geologic index. The geologic
# index can be determined using the first rule that applies from the list
# below:
...
# 48271. The erosion level is (48271 + 510) % 20183 = 8415. The type is 8415 %
# 3 = 0, rocky.
...
# mouth as M, the target as T, with 0,0 in the top-left corner, X increasing to
# the right, and Y increasing downward, the top-left corner of the map looks
# like this:
